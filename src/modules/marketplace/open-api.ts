			...
			schema: {
				example: {
					...
					result: {
						...
						"transaction_fee": 20,
						"authority": "EijtaNNHqqaPmWwAmUi8f1TC6gSPnqkoodQd2BLFpA8T",
						"encoded_transaction": ""
					},
				},
			},
		}),
...
export function SellerListingsOpenApi() {
	return applyDecorators(
		ApiOperation({ summary: 'Get all listings done by a seller in the marketplace' }),
		ApiOkResponse({
