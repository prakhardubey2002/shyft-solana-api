...
import { BuyListingOpenApi, CreateListingOpenApi, CreateMpOpenApi, UnlistOpenApi, UpdateMpOpenApi, WithdrawOpenApi } from "./open-api";
...
export class MarketplaceDetachController {
	...
	@UnlistOpenApi()
	@Version('1')
	async unlist(@Body() unlistDto: UnlistDto, @Req() request: any): Promise<any> {
